...
class Orders(TradierApiBase):
    ...
    def modify(self, order_id: int, duration: str = '', limit_price: Union[float | None] = None,
               stop_price: Union[float | None] = None) -> dict:
        """
    ...
    def order(self, symbol: str, side: str, quantity: Union[int | float], order_type: str, duration='day',
              limit_price: Union[float | None] = None, stop_price: Union[float | None] = None,
              tag: str = '') -> dict:
        """
        ...
        :param side: 'buy', 'sell', 'buy_to_cover', 'sell_short'
    ...
    def order_option(self, asset_symbol: str, option_symbol: str, side: str, quantity: Union[int | float],
                     order_type: str, duration='day', limit_price: Union[float | None] = None,
                     stop_price: Union[float | None] = None, tag: str = '') -> dict:
        """
